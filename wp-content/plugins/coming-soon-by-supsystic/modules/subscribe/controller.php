...
class subscribeControllerScs extends controllerScs {
	public function subscribe() {
		...
		if($this->getModel()->subscribe(reqScs::get('post'), true)) {
			...
			if(isset($lastBlock['params']['sub_dest']['val']) && $lastBlock['params']['sub_dest']['val'] != "newsletters"
				&&$destData && isset($destData['require_confirm']) && $destData['require_confirm'] && !$withoutConfirm)
